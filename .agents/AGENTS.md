...
O desenvolvimento, manutenção e operação do **Dialer-Go** (`go 1.25.0`) é regido por três workflows de agentes especializados e complementares:
...
3. 👉 [`.agents/workflows/agente-asterik-especialista.md`](file:///home/marcio/ominichat/dialer-go/.agents/workflows/agente-asterik-especialista.md): **Agente Especialista Asterisk (PBX, Dialplan & AMD Specialist).**
